...
# version subir archivo
# Seleccionar el archivo CSV
ruta_archivo <- file.choose()

# Leer el archivo CSV
data <- read.csv(ruta_archivo)
new_hours_played <- c(25,30,46,45,52,23,43,35,38,46,48,52,44,30) #se cambiaron los valores porque tenia unos valores equivocados
# Asignar los nuevos valores a la columna hours_played
data$Hours_Played <- new_hours_played

#version crear manualmente el df
